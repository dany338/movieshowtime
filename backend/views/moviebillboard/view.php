...
$start_date           = date('d M, Y g:i A', $model->start_date);
$end_date             = date('d M, Y g:i A', $model->end_date);
  ...
  <div class="col s12">
      <table class="kv-grid-table table table-hover table-bordered table-striped table-condensed kv-table-wrap">
        <tbody>
          ...
          <tr>
              <td class="text-center">Movie</td>
              <td class="kv-nowrap" style="text-align: justify; white-space: normal !important;">
                <?=$model->movie->name;?>
              </td>
          </tr>
          <tr>
              <td class="text-center">Theater</td>
              <td class="kv-nowrap" style="text-align: justify; white-space: normal !important;">
                <?=$model->movietheater->name;?>
              </td>
          </tr>
          <tr>
